...
<html>
  <head>
	...
	<meta name="author" content="vuongdq85">
    <meta name="copyright" content="quangvuong85">
...
document.write('<img src="'+rand+'" alt="logo" width="400" class="animated infinite pulse">');
    ...
    <script>
      ...
      function makeTimer() {
        ...
        let endTime = new Date("'03/17/2023 00:00:00 GMT+0700 (SE Asia Standard Time)");
